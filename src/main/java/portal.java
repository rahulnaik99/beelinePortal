...
public class portal {
    public static void getBeelineStatus(String[] reqID, WebDriver driver) throws FileNotFoundException {
        navigate nav = new navigate();

        File csvFile = new File("C:\\Users\\Rmnai\\OneDrive\\Desktop\\status.csv");
        ...
        for(String s : reqID) {
            ...
            try{
                ...
                System.out.print(S+","+s+","
                        +
                        driver.findElement(By.cssSelector("span[class='BeelineLabel'][id='Master_PageContentPlaceHolder_screen_beelineForm_statusLabel']")).getText()+","+
                        "Beeline ID Found but, No Profile submitted"+
                        endDate);
                out.print(S+","+s+","+driver.findElement(By.cssSelector("span[class='BeelineLabel'][id='Master_PageContentPlaceHolder_screen_beelineForm_statusLabel']")).getText()+","+
                        ","+","+"Beeline ID Found! and No Profile submitted,"+
                        endDate);
